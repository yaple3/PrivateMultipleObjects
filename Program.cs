namespace PrivateMultipleObjects
{
    ...
    internal class Program
    {
        private static void Main(string[] args)
        {
            ...
            KnittingClub[] knittingClub = new KnittingClub[maxKnitting];
                    ...
                    switch (choice)
                    {
                        case 1: // Add
                            ...
                            else // Knitting Club
                            {
                                ...
                                {
                                    knittingClub[knittingCounter] = new KnittingClub();
                                    knittingClub[knittingCounter].AddChange();
                                    knittingCounter++;
                                }
                                else
                                {
                        ...
                        case 2: // Change Club/Knitting Club Details
                            ...
                            ChangeClubDetails(club, clubCounter, knittingClub, knittingCounter);
                            break;

                        case 3: // Print All
                            PrintAllClubs(club, clubCounter, knittingClub, knittingCounter);
                            break;
                        case 4://Quit
